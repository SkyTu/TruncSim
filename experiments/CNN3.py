...
for _ in range(3):
    for fl in range(12, 25, 4):
        for trunc_type in [3]:
            ...
            optimizer = optim.SGD(params=model_cnn3.parameters(), momentum =0.90625,lr=0.015625, batch_size =BATCH_SIZE)
            ...
            for epoch in tqdm(range(EPOCHS)):
                ...
                for X, y in train_dataloader:
                    ...
                    if cnt % 10 == 0:
                        ...
                        with open(f'output/CNN3/'+truncation_type_name_list[trunc_type] + '-' + str(fl) +'.txt', 'a') as f:
                            f.write(f'{accuracy:.2f}\n')
                    cnt += 1
            with open(f'output/CNN3/highest_acc-'+truncation_type_name_list[trunc_type] + '-' + str(fl) +'.txt', 'a') as f:
